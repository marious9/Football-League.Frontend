...
export const Api = {
    ...
    League: {
        generateSchedule: leagueId => { return dataExtractor("post", "/league/generateSchedule/" + leagueId )},
        ...
        deleteLeague: leagueId => { return dataExtractor("delete", "/league/" + leagueId) },
        editLeague: (editLeagueModel, leagueId) => { return dataExtractor("put", "/league/" + leagueId, editLeagueModel) },
